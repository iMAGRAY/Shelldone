...
use shelldone_term::input::{MouseButton, MouseEventKind as TMEK};
use shelldone_term::{ClickPosition, LastMouseClick, StableRowIndex};
...
impl super::TermWindow {
    ...
    fn mouse_event_terminal(
        ...
        let mouse_event = shelldone_term::MouseEvent {
