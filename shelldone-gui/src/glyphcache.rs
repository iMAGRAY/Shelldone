...
use shelldone_blob_leases::{BlobLease, BlobManager, BoxedReader};
use shelldone_font::units::*;
use shelldone_font::{FontConfiguration, GlyphInfo, LoadedFont, LoadedFontId};
use shelldone_term::Underline;
...
impl GlyphCache {
    ...
    fn load_glyph(
        ...
        // can happen somehow; see <https://github.com/shelldone/shelldone/issues/1042>
        ...
        match &*handle.h {
            ...
            ImageDataType::AnimRgba8 {
                ...
                if frames.len() > 1 {
                    ...
                    // frame duration that shelldone can use when rendering.
                    ...
                    // <https://github.com/shelldone/shelldone/issues/3260>
