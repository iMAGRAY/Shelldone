...
use shelldone_dynamic::{ToDynamic, Value};
...
impl InputMap {
    ...
    pub fn new(config: &ConfigHandle) -> Self {
        ...
        if !config.disable_default_key_bindings {
            for (mods, code, action) in CommandDef::default_key_assignments(config) {
                ...
                // normalization under X11: <https://github.com/shelldone/shelldone/issues/1906>.
                ...
                //
                // See: <https://github.com/shelldone/shelldone/issues/3262>
    ...
    pub fn dump_config(&self, key_table: Option<&str>) {
        println!("local shelldone = require 'shelldone'");
        println!("local act = shelldone.action");
        println!();
        println!("return {{");
