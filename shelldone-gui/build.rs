fn main() {
    ...
    #[cfg(windows)]
    {
        ...
        // version number that we report in shelldone -h.
...
BEGIN
    ...
    BEGIN
        BLOCK "040904E4"
        BEGIN
            VALUE "CompanyName",      "Shelldone Labs\0"
            VALUE "FileDescription",  "Shelldone Terminal Emulator\0"
            VALUE "FileVersion",      "{version}\0"
            VALUE "LegalCopyright",   "© 2025 Shelldone Labs, MIT licensed\0"
            VALUE "InternalName",     "\0"
            VALUE "OriginalFilename", "\0"
            VALUE "ProductName",      "Shelldone\0"
...
"#,
    ...
    #[cfg(target_os = "macos")]
    {
        ...
        println!("cargo:rerun-if-changed=assets/macos/Shelldone.app/Contents/Info.plist");
