shelldone has support for both implicit and explicit hyperlinks.
...
[default_hyperlink_rules](config/lua/shelldone/default_hyperlink_rules.md).


### Explicit Hyperlinks

shelldone supports the relatively new [Hyperlinks in Terminal
