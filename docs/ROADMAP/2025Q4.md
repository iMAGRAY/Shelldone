...
## Program Snapshot — 4 October 2025
- Overall progress 15 % (`agentcall status`, health: yellow). Next milestone **QA Hardening** due **2025-10-31**.
- Active epics: **epic-qa-hardening** 57 % (gatekeeper for verify), **epic-ai-automation** 24 % (TermBridge + MCP runway).
- Top delivery focus: TermBridge discovery/core, MCP bridge hardening, QA pipeline stabilization.
...
## Epic Map
| Epic ID | Title | Status | Priority | Size | Progress |
| --- | --- | --- | --- | --- | --- |
| epic-qa-hardening | QA pipeline and quality budgets | in_progress | P0 | 20 | 57% |
| epic-plugin-platform | Plugin architecture and IDE layer | planned | P0 | 20 | 0% |
| epic-ai-automation | AI integration and agent workflows | in_progress | P1 | 13 | 24% |
| epic-animation-engine | High-performance animation engine | planned | P1 | 13 | 0% |
| epic-ide-dx | IDE functionality and DX | planned | P2 | 8 | 0% |
| epic-platform-resilience | Resilience, security, operations | planned | P0 | 20 | 0% |

## Task Table
| Task ID | Epic | Type | Size | Status | Progress | Scope (first entries) |
| --- | --- | --- | --- | --- | --- | --- |
| task-agent-microsoft | epic-ai-automation | feature | 5 | planned | 0% | agents/microsoft/**, docs/architecture/ai-integration.md |
...
| task-animation-core | epic-animation-engine | perf | 8 | planned | 0% | docs/architecture/animation-framework.md, shelldone-gui/** |
| task-animation-toolkit | epic-animation-engine | feature | 5 | planned | 0% | docs/recipes/animations.md, plugins/examples/** |
| task-ide-file-manager | epic-ide-dx | feature | 8 | planned | 0% | term/**, docs/recipes/workflows.md |
| task-marketplace-hooks | epic-plugin-platform | feature | 5 | planned | 0% | docs/architecture/utif-sigma.md, docs/architecture/plugin-marketplace.md |
| task-mcp-bridge | epic-ai-automation | feature | 8 | in_progress | 50% | docs/architecture/ai-integration.md, shelldone-client/** |
| task-observability-pipeline | epic-platform-resilience | ops | 5 | planned | 0% | docs/architecture/observability.md, scripts/verify.py |
...
| task-persona-engine | epic-ai-automation | feature | 8 | planned | 0% | config/personas/**, docs/architecture/utif-sigma.md |
| task-plugin-examples | epic-plugin-platform | doc | 5 | planned | 0% | plugins/examples/**, docs/recipes/plugins.md |
| task-plugin-sdk | epic-plugin-platform | feature | 13 | planned | 0% | plugins/sdk/**, docs/architecture/customization-and-plugins.md |
| task-qa-marker-baseline | epic-qa-hardening | ops | 5 | done | 100% | qa/baselines/banned_markers.json, scripts/verify.py |
| task-qa-orchestrator | epic-qa-hardening | ops | 8 | done | 100% | scripts/verify.py, scripts/verify.sh |
| task-qa-perf-probes | epic-qa-hardening | perf | 5 | planned | 0% | docs/architecture/perf-budget.md, ci/** |
| task-release-hardening | epic-platform-resilience | ops | 5 | planned | 0% | docs/architecture/release-and-compatibility.md, ci/** |
| task-security-agent-gov | epic-ai-automation | doc | 5 | planned | 0% | docs/architecture/security-and-secrets.md, docs/architecture/ai-integration.md |
| task-security-hardening | epic-platform-resilience | perf | 5 | planned | 0% | docs/architecture/security-and-secrets.md, lua-api-crates/** |
...
| task-termbridge-core | epic-ai-automation | feature | 8 | in_progress | 50% | docs/architecture/termbridge.md, docs/architecture/observability.md |
| task-termbridge-discovery | epic-ai-automation | feature | 5 | in_progress | 50% | docs/architecture/termbridge.md, shelldone-agentd/src/adapters/termbridge/mod.rs |
| task-termbridge-test-suite | epic-qa-hardening | ops | 5 | planned | 0% | scripts/tests/termbridge_matrix.py, ci/** |
| task-utif-sigma-foundation | epic-platform-resilience | ops | 8 | planned | 0% | docs/architecture/utif-sigma.md, scripts/perf/** |
