...
shelldone.action.SpawnCommandInNewWindow {
  ...
  -- If omitted, shelldone will infer a value based on the active pane
  ...
  -- shelldone using `shelldone connect` or `shelldone serial` then the default
  ...
  -- shelldone.mux.spawn_window, SpawnCommandInNewWindow
  position = {
    x = 10,
    y = 300,
