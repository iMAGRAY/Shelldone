...
/// AgentProxy manages an agent.PID symlink in the shelldone runtime
/// directory.
...
///
/// As a further complication, when a shelldone proxy client is
...
impl AgentProxy {
    ...
    fn update_now(&self) {
        ...
        clients.sort_by(|a, b| {
            ...
            // in shelldone-mux-server-impl/src/sessionhandler.rs
