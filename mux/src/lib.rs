...
use shelldone_term::{Clipboard, ClipboardSelection, DownloadHandler, TerminalSize};
    ...
    let (mut tx, rx) = match allocate_socketpair() {
        ...
        Err(err) => {
            ...
            localpane::emit_output_for_pane(
                pane_id,
                &format!(
                    "⚠️  shelldone: read_from_pane_pty: \
...
impl shelldone_term::DownloadHandler for MuxDownloader {
