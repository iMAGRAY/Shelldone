...
pub use shelldone_char_props::emoji::Presentation;
use shelldone_char_props::emoji_variation::WCWIDTH_TABLE;
use shelldone_char_props::widechar_width::WcWidth;
use shelldone_dynamic::{FromDynamic, ToDynamic};
pub use shelldone_escape_parser::osc::Hyperlink;
...
pub use shelldone_escape_parser::csi::{Blink, Intensity, Underline, VerticalAlign};
...
impl CellAttributes {
    ...
    pub fn clone_sgr_only(&self) -> Self {
        ...
        // <https://github.com/shelldone/shelldone/issues/2489>
...
impl UnicodeVersion {
    ...
    fn width(&self, c: WcWidth) -> usize {
        ...
        // <https://github.com/shelldone/shelldone/issues/1864>
...
pub fn is_white_space_char(c: char) -> bool {
    shelldone_char_props::white_space::WHITE_SPACE.contains_u32(c as u32)
}
...
///
/// The approach that shelldone wants to take here is to define a
...
mod test {
    ...
    // See <https://github.com/shelldone/shelldone/issues/6637>
    ...
    // That decision is made over in shelldone-term when processing
    ...
    fn issue_6637() {
        ...
        // due to <https://github.com/shelldone/shelldone/issues/1422>.
