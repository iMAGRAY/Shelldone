...
class OpenInShelldoneAction(GObject.GObject, Nautilus.MenuProvider):
    def __init__(self):
        super().__init__()
    ...
    def _make_item(self, name, paths):
        item = Nautilus.MenuItem(name=name, label='Open in Shelldone',
            icon='net.shelldone.terminal')
    ...
    def get_file_items(self, *args):
        ...
        if paths:
            return [self._make_item(name='ShelldoneNautilus::open_in_shelldone', paths=paths)]
        else:
            return []
    ...
    def get_background_items(self, *args):
        ...
        if paths:
            return [self._make_item(name='ShelldoneNautilus::open_folder_in_shelldone', paths=paths)]
        else:
            return []
