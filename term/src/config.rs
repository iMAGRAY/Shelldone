...
use shelldone_surface::{Line, SequenceNo};
...
impl Default for NewlineCanon {
    fn default() -> Self {
        ...
        //
        // To come to a compromise, if shelldone is running on Windows then we'll
        ...
        if cfg!(windows) {
            ...
            // <https://github.com/shelldone/shelldone/issues/1575>
            Self::CarriageReturn
        }
    }
}
