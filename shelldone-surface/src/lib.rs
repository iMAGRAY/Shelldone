...
use shelldone_cell::color::ColorAttribute;
#[cfg(feature = "use_image")]
use shelldone_cell::image::ImageCell;
use shelldone_cell::{Cell, CellAttributes};
...
mod test {
    use super::*;
    use alloc::sync::Arc;
    use shelldone_cell::color::AnsiColor;
    use shelldone_cell::image::ImageData;
    use shelldone_cell::{AttributeChange, Intensity};
