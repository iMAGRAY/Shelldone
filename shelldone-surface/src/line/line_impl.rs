...
use shelldone_bidi::{Direction, ParagraphDirectionHint};
use shelldone_cell::{Cell, CellAttributes, SemanticType, UnicodeVersion};
...
impl Line {
    ...
    pub fn split_off(&mut self, idx: usize, seqno: SequenceNo) -> Self {
        ...
        // <https://github.com/shelldone/shelldone/issues/2355>
    ...
    fn set_cell_impl(&mut self, idx: usize, cell: Cell, clear: bool, seqno: SequenceNo) {
        ...
        // https://github.com/shelldone/shelldone/issues/768
