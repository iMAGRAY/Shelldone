        ...
        match value {
            ...
            other => {
                if let Some(value) = value.coerce_unsigned() {
                    ...
                    Err(shelldone_dynamic::Error::NoConversion {
...
impl std::fmt::Display for FontAttributes {
    fn fmt(&self, fmt: &mut std::fmt::Formatter) -> Result<(), std::fmt::Error> {
        write!(
            fmt,
            "shelldone.font('{}', {{weight={}, stretch='{}', style={}}})",
...
impl TextStyle {
    ...
    ///
    /// <https://github.com/shelldone/shelldone/issues/456>
...
pub struct StyleRule {
    ...
    /// "Half".
    pub intensity: Option<shelldone_term::Intensity>,
    ...
    /// "Double".
    pub underline: Option<shelldone_term::Underline>,
    ...
    /// a value that matches this rule.
    pub blink: Option<shelldone_term::Blink>,
