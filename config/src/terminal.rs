...
impl shelldone_term::TerminalConfiguration for TermConfig {
    ...
    fn canonicalize_pasted_newlines(&self) -> shelldone_term::config::NewlineCanon {
        match self.configuration().canonicalize_pasted_newlines {
            None => shelldone_term::config::NewlineCanon::default(),
            Some(NewlineCanon::None) => shelldone_term::config::NewlineCanon::None,
            Some(NewlineCanon::LineFeed) => shelldone_term::config::NewlineCanon::LineFeed,
            Some(NewlineCanon::CarriageReturn) => {
                shelldone_term::config::NewlineCanon::CarriageReturn
            }
            Some(NewlineCanon::CarriageReturnAndLineFeed) => {
                shelldone_term::config::NewlineCanon::CarriageReturnAndLineFeed
            }
        }
    }
