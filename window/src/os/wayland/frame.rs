...
use shelldone_color_types::SrgbaTuple;
use shelldone_font::{FontConfiguration, FontMetrics, GlyphInfo, RasterizedGlyph};
use shelldone_input_types::WindowDecorations;
    ...
    fn reshape_title(&mut self) -> Option<()> {
        ...
        let infos = font
            .shape(
                ...
                None,
                shelldone_bidi::Direction::LeftToRight,
                None,
                None,
            )
            .ok()?;
